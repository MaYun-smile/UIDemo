...
export default (BaseComponent, listId) => {
    return class ListRowWrapComponent extends Component {
        ...
        //     var list = this.context.getContextComponent(listId);
        //     var json = {};
        //     for (var col of list.columnInfo) {
        //         json[col.key] = {
        //             'enable': false,
        //             'visible': true,
        //             'editable': false,
        ...
        //         }
        //     }
        //     this.virtualState = Immutable.fromJS(json);
        // }

        render() {
            const list = this.context.getContextComponent(listId)
            return <BaseComponent {...this.props} yigoid={listId} list={list}></BaseComponent>;
        }
    }
}
