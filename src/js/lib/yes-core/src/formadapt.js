...
import './component/componentmgr';
import './utils/gridlookuputil';

export default YIUI.FormAdapt = function (options) {
    var Return = {
        form: null,
        compList: {},
        orderList: [],
        ...
        load: function () {
            ...
            var loadComp = function (array, parentCom) {
                ...
                if (parentCom.type == YIUI.CONTROLTYPE.LISTVIEW) {
                    ...
                    YIUI.GridLookupUtil.buildCellLookup(_this.form, parentCom);
                } else if (parentCom.type === YIUI.CONTROLTYPE.TABLEVIEW) {
                    YIUI.GridLookupUtil.buildCellLookup(_this.form, parentCom);
                } else if (parentCom.type == YIUI.CONTROLTYPE.RADIOBUTTON) {
                    _this.radioMap[parentCom.metaObj.groupKey || ''] = _this.radioMap[parentCom.metaObj.groupKey || ''] || [];
                    _this.radioMap[parentCom.metaObj.groupKey || ''].push(parentCom);
